...
<table border=0 cellpadding=0 cellspacing=0 width=666 style='border-collapse:
 ...
 <tr class=xl6312210 height=40 style='mso-height-source:userset;height:30.0pt'>
  ...
  <td class=xl7312210 style="text-align:center;"><?= isset($obj->ex_date)? $obj->ex_date: '' ?></td>
 ...
 <tr class=xl6312210 height=40 style='mso-height-source:userset;height:30.0pt'>
  ...
  <td colspan=4 class=xl7512210 style='border-right:.5pt solid black'>　
      <?php
      $invname = '';
      if($obj->ex_invname != '') {
          $invname = explode(' ', $obj->ex_invname)[0];
          $invname .= ' ' . $obj->ex_invinum . '人';
      }
      echo($invname);
      ?>
  </td>
 ...
 <tr class=xl6312210 height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td class=xl6412210></td>
  <td class=xl6412210></td>
  <td colspan=5 class=xl6512210>年<span style='mso-spacerun:yes'>   
 ...
 <tr class=xl6312210 height=17 style='mso-height-source:userset;height:12.75pt'>
  <td height=17 class=xl6412210 style='height:12.75pt'></td>
  <td class=xl6412210></td>
  <td class=xl6412210></td>
  <td class=xl6412210></td>
  <td class=xl6412210></td>
