...
_MenuTree.prototype.Mark = function(absURL, oLink)
{
	...
	{
		var strUrl = location.protocol+"//" + location.host + absURL.toLowerCase();
...
//	var oFrom = this.ActiveLink.parentNode.parentNode.parentNode.parentNode;
	var oFrom = this.ActiveLink.parentNode.nextSibling;
	if(!oFrom)oFrom=this.ActiveLink.parentNode.parentNode.parentNode.parentNode;
